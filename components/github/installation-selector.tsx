    ...
    <div className="px-2.5 py-3 sticky top-0 z-20 bg-white/90 backdrop-blur-sm">
      <DropdownMenu open={dropdownOpen} onOpenChange={setDropdownOpen}>
        <DropdownMenuTrigger asChild>
          <button
            type="button"
            className="flex items-center justify-between w-full p-3 bg-white border border-neutral-200 rounded-lg hover:bg-neutral-50 transition-colors"
          >
            {selectedInstallation ? (
              <div className="flex items-center gap-2">
                ...
                <Badge
                  variant="outline"
                  className="h-4 text-xs px-1.5 border-neutral-300 text-neutral-600 bg-white"
                >
                  {repositoryCount}
                </Badge>
              </div>
              ...
              <div className="flex items-center gap-2">
                <div className="relative flex size-5 shrink-0 overflow-hidden rounded-full">
                  <div className="flex size-full items-center justify-center rounded-full bg-neutral-100 border text-neutral-600">
                    <Building2 className="size-3" />
                  </div>
                </div>
          ...
          {isLoading ? (
            <div className="">
              {Array.from({ length: 3 }, (_, index) => (
                ...
                <div
                  key={`installation-skeleton-${index}`}
                  className="flex items-center justify-between p-3 cursor-pointer"
                >
                  <div className="flex items-center gap-2">
                    <Skeleton className="size-5 rounded-full bg-neutral-200" />
              ...
              >
                <div className="flex items-center gap-2">
                  <Avatar className="size-8 rounded">
                    <AvatarFallback className="bg-neutral-200 rounded shadow-inner text-neutral-600">
